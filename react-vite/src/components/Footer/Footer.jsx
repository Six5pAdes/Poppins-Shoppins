...
function Footer() {
    ...
    return (
        <div className='footer-container'>
            ...
            <a className='gitlink' href='https://github.com/Six5pAdes/Poppins-Shoppings'>https://github.com/Six5pAdes/Poppins-Shoppings</a>
            <div className='icons-container'>
                ...
                <a className='footer-icons-link' href='https://github.com/Six5pAdes' target='_blank' rel='noreferrer'>
                    {/* <svg className='foot-logos' fill="#000000" width="40px" height="40px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <title>github</title>
                ...
                <a className='footer-icons-link' href='https://six5pades.github.io/' target='_blank' rel='noreferrer'>My Portfolio</a>
            </div>
        </div>
    )
}
