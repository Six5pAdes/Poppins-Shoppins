    ...
    return (
        <div className='footer-container'>
            ...
            <div className='icons-container'>
                ...
                <a className='footer-icons-link' href='https://github.com/Six5pAdes/Poppins-Shoppings' target='_blank' rel='noreferrer'>
                ...
                <a className='footer-icons-link' href='https://six5pades.github.io/' target='_blank' rel='noreferrer'>Portfolio</a>
            </div>
        </div>
    )
}
